...
export interface UpdateQuickBooksInvoiceSalesItemLineDto
  extends CreateQuickBooksInvoiceSalesItemLineDto {
  Id: string;
}

export interface UpdateQuickBooksInvoiceGroupLineDto
  extends CreateQuickBooksInvoiceGroupLineDto {
  Id: string;
}

export interface UpdateQuickBooksInvoiceDescriptionOnlyLineDto
  extends CreateQuickBooksInvoiceDescriptionOnlyLineDto {
  Id: string;
}

export interface UpdateQuickBooksInvoiceDiscountLineDto
  extends CreateQuickBooksInvoiceDiscountLineDto {
  Id: string;
}

export interface UpdateQuickBooksInvoiceSubTotalLineModel
  extends CreateQuickBooksInvoiceSubTotalLineModel {
  Id: string;
}
...
export interface SparseUpdateQuickBooksInvoicesDto
  extends QuickBooksInvoicesDto {
  CustomerRef?: QuickBooksRefDto;
  Line?: UpdateQuickBooksInvoiceLines[];
}
